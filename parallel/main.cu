 ...
 *                demonstrates the use of parallel AES implementation
 ******************************************************************************/
#include <iostream>
#include <cstdlib>
#include <cstring>
...
int main (int argc, char* argv[])
{
    ...
    // Variable to store IV for CTR mode
    ...
    // Generating random numbers for both key and plain text
    ...
    printf("************************************************************\n");
    printf("*    AES Acceleration with GPU - Parallel implemntation    *\n");
    printf("************************************************************\n");
    ...
    printf("\nTime taken for keygen using OpenMP - %lf\n", (end-begin)*1000);
#endif
...
#if TIME_CUDA
    // Variable to save time in ms
    float ms;
    
    // Calculate the time for kernel execution
    ...
    printf("\nTime taken for AES encryption using cuda - %lf\n", ms);
#endif
