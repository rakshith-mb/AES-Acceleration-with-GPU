/******************************************************************************
 * File Name    - aes_parallel.cuh
 * 
 * Description  - This is the header file for the aes_parallel code
 ******************************************************************************/

#ifndef SOURCE_AES_PARALLEL_CUH
#define SOURCE_AES_PARALLEL_CUH
...
__device__ uint8_t aes_galoi_mult(uint8_t num, uint8_t mult);
